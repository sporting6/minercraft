...
public class CondenserRecipe implements Recipe<SimpleContainer> {
    ...
    public CondenserRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<CondenserRecipe>{
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(Krasyrum.MODID,"condensing");

        @Override
        public CondenserRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new CondenserRecipe(id, output, inputs);
        }
