...
public final class ModToolMaterials {
	...
	public static final Tier BLUE_NANITARIUM = TierSortingRegistry.registerTier(
			new ForgeTier(5 ,2670, 10f, 0, 16, ModTags.BLUE_NANITARIUM_TAG,() -> Ingredient.of(ModIngots.BLUE_NANITARIUM_INGOT.get())),
			new ResourceLocation("krasyrum:blue_nanitarium"),
			List.of(Tiers.NETHERITE), List.of());
	
	public static final Tier KYRANIUM = TierSortingRegistry.registerTier(
			new ForgeTier(6 ,4200, 33f, 4, 26, ModTags.KYRANIUM_TAG,() -> Ingredient.of(ModIngots.KYRANIUM_INGOT.get())),
	...
	public static final Tier RED_NANITARIUM = TierSortingRegistry.registerTier(
			new ForgeTier(5 ,2100, 8f, 0, 19, ModTags.RED_NANITARIUM_TAG,() -> Ingredient.of(ModIngots.RED_NANITARIUM_INGOT.get())),
	...
	public static final Tier VERANIUM = TierSortingRegistry.registerTier(
			new ForgeTier(3 ,1869, 100f, 0, 27, ModTags.VERANIUM_TAG,() -> Ingredient.of(ModIngots.VERANIUM_INGOT.get())),
	...
	public static final Tier TITANIUM = TierSortingRegistry.registerTier(
			new ForgeTier(2 ,500, 7.5f, 0, 12,ModTags.TITANIUM_TAG,() -> Ingredient.of(ModIngots.TITANIUM_INGOT.get())),
	...
	public static final Tier RUBY = TierSortingRegistry.registerTier(
			new ForgeTier(2 ,700, 10f, 0, 18,ModTags.RUBY_TAG,() -> Ingredient.of(ModIngots.RUBY.get())),
