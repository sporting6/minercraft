...
public class StrainerScreen extends AbstractContainerScreen<StrainerMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(Krasyrum.MODID, "textures/gui/strainer.png");

    public StrainerScreen(StrainerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
